<template>
  <el-card class="box">
    ...
    <!-- 级联 -->
    <el-form class="form" label-position="left" label-width="120px">
    ...
    <el-tabs @click="changeTab()" type="border-card" v-model="active">
      ...
      <el-tab-pane name="2" label="静态参数">
        ...
        <el-table height="450px" border stripe :data="arrStatic" style="width: 100%">
          ...
          <el-table-column prop="attr_name" label="属性名称"></el-table-column>
          <el-table-column prop="attr_name" label="属性值"></el-table-column>
          <el-table-column label="操作" width="100">
            <template slot-scope="scope">
              <el-button plain size="mini" type="primary" icon="el-icon-edit" circle></el-button>
              <el-button plain size="mini" type="danger" icon="el-icon-delete" circle></el-button>
